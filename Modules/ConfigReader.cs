...
namespace POE2FlipTool.Modules
{
    internal class ConfigReader
    {
        ...
        public static List<TradedItem>? GetPoeNinjaList(string poeVersion)
        {
            ...
            return ninja.Economy.GetTradedItemsAboveVolume(1000, Poe2EconomyType.Currency | Poe2EconomyType.Fragments | Poe2EconomyType.Breach | Poe2EconomyType.Abyss | Poe2EconomyType.UncutGems)?.Take(5).ToList();
        }
    }
}
