...
namespace POE2FlipTool.Modules
{
    ...
    public class PricingChecker
    {
        ...
        public List<MarketListing> ScreenShotAndGetCurrentTradeRatio(string buyItem = "Custom", string sellItem = "Custom", bool reverse = false)
        {
        ...
        private List<MarketListing> ExtractMarketValue(string buyItem, string sellItem, Bitmap bitmap, bool reverse = false)
        {
            List<MarketListing> rates = new List<MarketListing>();
        ...
        private MarketListing ExtractRatio(string itemName, Bitmap bitmap, bool reverse = false)
        {
            string result = "";
            ...
            return new MarketListing(ratio, stock);
        }
